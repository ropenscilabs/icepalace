...
fs::dir_tree(destdir)
#> /tmp/RtmpEvfrto/filea06a3f1db7cc
#> ├── bin
#> │   ├── macosx
#> │   │   └── contrib
#> │   │       └── 4.2
...
repo
#> [1] "file:////tmp/RtmpEvfrto/filea06a3f1db7cc"
...
#> Warning: ✖ Can't find any package win.binary for repository `https://r-lib.r-universe.dev/bin/windows/contrib/3.3`.
